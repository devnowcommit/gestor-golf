...
document.getElementById('landing-training-btn').addEventListener('click', () => showZone('training'));
document.getElementById('landing-championship-btn').addEventListener('click', () => showZone('championship'));
